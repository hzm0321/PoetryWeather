...
public class FMPoetryDetailRemark extends Fragment {
    private View view;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.remark_fragment, container, false);
        return view;
    }
    ...
    public void onStart() {
        ...
        TextView tvRemark = view.findViewById(R.id.tv_poetry_detail_remark);
